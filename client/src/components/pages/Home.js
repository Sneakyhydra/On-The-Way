    ...
    <div>
      ...
      <div className='footer'>
        ...
        <div className='innertxt'>
          ...
          <h5>
            Meanwhile, know more about: <a href='#!'>Anxiety</a> |{" "}
            <a href='#!'>Counselling</a> | <a href='#!'>Stress</a> |{" "}
            <a href='#!'>Depression</a> | <a href='#!'>Addiction</a>{" "}
          </h5>
        </div>
